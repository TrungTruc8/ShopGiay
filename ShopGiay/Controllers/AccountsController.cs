...
namespace ShopGiay.Controllers
{
    ...
    public class AccountsController : Controller
    {
        ...
        public AccountsController(dbSneakersContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Login(LoginViewModel customer, string returnUrl)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (khachhang == null) { _notyfService.Success("Thông tin đăng nhập chưa chính xác"); return RedirectToAction("DangkyTaiKhoan"); }
