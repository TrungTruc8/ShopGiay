...
namespace ShopGiay.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(dbSneakersContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index() 
        {
            ...
            var dbSneakersContext = _context.Accounts.Include(a => a.Role);
            return View(await dbSneakersContext.ToListAsync());
        }
